            ...
            {(application.references && application.references.length) ? (
              <div className="row g-3">
                {application.references.map((r, idx) => (
                  <div className="col-12" key={`${r.referenceNumber || idx}`}>
                    <div className="profile-label mb-2">Reference #{r.referenceNumber ?? (idx+1)}</div>
                    <div className="row g-3 align-items-start">
                      <div className="col-12 col-md-3">
                        <div className="profile-label">Name</div>
                        <div className="profile-value">{r.name || '—'}</div>
                      </div>
                      <div className="col-12 col-md-3">
                        <div className="profile-label">Relationship</div>
                        <div className="profile-value">{r.relationship || '—'}</div>
                      </div>
                      <div className="col-12 col-md-3">
                        <div className="profile-label">Contact</div>
                        <div className="profile-value">{r.contactNumber || '—'}</div>
                      </div>
                      <div className="col-12 col-md-3">
                        <div className="profile-label">Address</div>
                        <div className="profile-value">{r.address || '—'}</div>
                      </div>
                    </div>
                  </div>
                ))}
                ...
                {previewFile.type?.startsWith('image/') ? (
                  ...
                  >
                    <div style={{ textAlign: 'center', padding: '40px', color: '#666' }}>
                      <p style={{ marginBottom: 0 }}>PDF preview not available in this browser. Close to return.</p>
                    </div>
                  </iframe>
                ) : (
                  <div style={{ textAlign: 'center', padding: '40px' }}>
                    ...
                    <p style={{ marginTop: '10px', color: '#666' }}>Close to return.</p>
                  </div>
                )}
              </div>
            </div>
